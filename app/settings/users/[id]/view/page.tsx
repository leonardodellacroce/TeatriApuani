      ...
      <div>
        <div className="flex items-center gap-3 mb-4">
          <button
            ...
            aria-label="Indietro"
            title="Indietro"
            className="h-11 w-11 inline-flex items-center justify-center rounded-lg bg-gray-900 text-white hover:bg-gray-800 hover:shadow-lg hover:scale-105 active:scale-100 transition-all duration-200 cursor-pointer"
          >
